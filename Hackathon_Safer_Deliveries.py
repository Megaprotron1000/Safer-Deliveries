...
def create_list():
    ...
    for name in ["FedEx", "UPS", "DHL"]:
        order_date = today - datetime.timedelta(days=random.randint(1, 10))
...
answer = input("Do you want to create a list of delivery systems or track a specific delivery? (create/track/exit) ").lower()
